...
def list_prompt_blocks(
    role: str = Query(..., pattern="^(planner|checker|drafter|brain_writer|action_writer|memory_redo|memory_qa)$"),
...
def list_agent_profiles(
    role: str | None = Query(None, pattern="^(planner|checker|drafter|brain_writer|action_writer|memory_redo|memory_qa)$"),
