...
def _build_sections_prompt(template: AiReplyTemplate) -> str:
...
def build_prompt_and_generate(
    ...
    *,
    ...
    blocks = [_build_sections_prompt(template)]
    ...
    return gemini_client.generate_text(system_prompt, user_message)
