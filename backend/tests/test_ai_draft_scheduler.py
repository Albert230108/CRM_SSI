...
def test_due_trigger_generates_draft_and_is_removed(monkeypatch):
    monkeypatch.setattr(ai_reply_service.gemini_client, "generate_text_flat", lambda prompt, **kwargs: "Auto-generated reply")
...
def test_trigger_not_yet_due_is_left_alone(monkeypatch):
    monkeypatch.setattr(ai_reply_service.gemini_client, "generate_text_flat", lambda prompt, **kwargs: "should not be called")
