          ...
          <table className="w-full min-w-[720px] table-fixed text-left text-sm">
            <thead>
              <tr className="border-b border-gray-200 text-xs font-semibold uppercase tracking-wide text-gray-500">
                <th className="w-[40%] px-3.5 py-2.5">Name</th>
                <th className="w-[15%] px-3.5 py-2.5">Sections</th>
                <th className="w-[25%] px-3.5 py-2.5">Includes</th>
                <th className="w-[20%] px-3.5 py-2.5 text-right">Actions</th>
              </tr>
            </thead>
            <tbody>
              {templates.map((template) => (
                <tr key={template.id} className="border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
                  <td className="px-3.5 py-2.5">
                    <p className="break-words font-semibold text-gray-900">{template.name}</p>
                    {template.description ? <p className="mt-0.5 break-words text-xs text-gray-500">{template.description}</p> : null}
                  </td>
