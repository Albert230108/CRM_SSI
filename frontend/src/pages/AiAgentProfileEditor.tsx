...
const INSTRUCTIONS_PLACEHOLDER: Record<AgentRole, string> = {
  ...
  sales_manager: 'e.g. Summarise the computed charges plainly, never invent prices, and set a sensible refundable deposit.',
  executor: 'e.g. Approve a Beds24 push only when the guest has explicitly accepted the price and there are no refund/dispute keywords in the conversation.',
  ...
  run_qa: 'e.g. Explain what the run did using only its own log; if the log does not say, state that plainly.',
}
