    ...
    <div className="flex flex-wrap items-center gap-2" data-channel={channel} data-tenant-id={tenantId} data-message-length={message.trim().length}>
      ...
      {onPreviewAiPayload ? (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-semibold text-gray-600 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
